...
class MultiFrequencyChannelAttention(nn.Module):
    def __init__(self,
        ...
        # Teacher Feedback Fix: Initialize mask to ~1.0 (Identity) to avoid signal loss at start.
        # sigmoid(3.0) ~= 0.95. Initialize weights near 0.
        ...
        # Set the last conv's bias to +3.0
    ...
    def forward(self, x):
        ...
        # Ensure input size matches DCT size, or pool it
